...
public class Client5 {
    ...
    void erstelleNachricht(Socket skt) {
        try {
            Request5 request = erstelleBefehl(skt);
            ...
            try {
                ...
                if (programmBeenden.equalsIgnoreCase("y")) {
                    schickeNachrichten(skt, new Request5("exit", null));
                    br.close();
                }
     ...
     */
    private Request5 erstelleBefehl(Socket skt) {
        System.out.print("$> ");
        String nachricht;
        try {
     ...
     */
    void schickeNachrichten(Socket skt, Request5 nachricht) {
        try {
...
//            System.out.println(nachricht);
    ...
    void leseNachrichten(Socket skt, Thread thread) {
        try {
            ...
            Response5 response = gson.fromJson(mail, Response5.class);
//            response.getRes();
